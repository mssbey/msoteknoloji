...
export function WhatsAppButton({
  phoneNumber = '905XXXXXXXXX',  // .env'den gelecek
  productName,
  productUrl,
  ...
  const buildMessage = () => {
    if (productName && productUrl) {
      return `Merhaba ${storeName}! 👋\n\n"${productName}" ürünü hakkında bilgi almak istiyorum.\n\n🔗 Ürün linki: ${productUrl}\n\nStok durumu ve kargo süresi hakkında bilgi verir misiniz?`
    }
      ...
      {visible && (
        ...
        >
          ...
          <motion.button
            ...
            onClick={handleClick}
            className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/40 hover:shadow-[#25D366]/60 transition-shadow"
